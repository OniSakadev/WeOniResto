  ...
  return (
    <section id="about" className="flex p-32 max-lg:flex-col max-lg:p-4">
      <div className="w-1/2 flex flex-col items-center max-lg:justify-center max-lg:w-full ">
        <h2 className="title -mb-10 max-lg:text-6xl max-lg:text-center" data-aos="fade-right">Descubrir</h2>
        <h4 className="sub-title z-10 max-lg:text-3xl max-lg:mt-1 max-lg:text-center" data-aos="fade-left">Nuestra tienda</h4>
        ...
        Oni-Resto es un restaurante ubicado en Indonesia y tiene muchos tipos de comida de todo el mundo. Halal certificado para evitar cosas no deseadas
        </p>
